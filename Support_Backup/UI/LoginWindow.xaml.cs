...
namespace PivdcSupportUi
{
    ...
    {
        /// <summary>
        /// Property object of the userinterface event operation to access the methods.
        /// </summary>
        ...
        /// <summary>
        /// PasswordChanged event to update the show paasword data.
        /// </summary>
        /// <param name="sender">Root of the source information.</param>
        /// <param name="e">Event state information.</param>
        private void txtPassword_PasswordChanged(object sender, RoutedEventArgs e)
        {
            LoggingInProcessObj.PasswordBoxPasswordChanged(sender, e);
        }
    }
}