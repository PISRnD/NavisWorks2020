...
namespace PivdcNavisworksSupportModel
{
    public static class SupportDatas
    {
        ...
        private static readonly string RvtToolConn = "Data Source=10.25.2.171;Initial Catalog=AppDatabase;User ID=admin;pwd=^zJ-bz8uRYH=`B)=yjXWMew[3GXgaZ{<";
        private static readonly string CntrlLoginConn = "Data Source=10.25.2.171;Initial Catalog=CentralLogin;User ID=admin;pwd=^zJ-bz8uRYH=`B)=yjXWMew[3GXgaZ{<";
        public static string CentralLoginConnectionString { get { return CntrlLoginConn; } }
        public static string RevitToolConnectionString { get { return RvtToolConn; } }
        ...
        public static string InsertUsageAmazonLink { get; set; }
        public static string EmployeeId { get; set; }
        public static string ErrorMessageTitle { get; set; }
        public static string ToolReleaseVersion { get; set; }
        public static string ToolReleaseDate { get; set; }
    }
}